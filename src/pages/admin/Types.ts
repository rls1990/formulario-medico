...
export const initialValues: FormularioFormValues = {
  ...
  primer_sintoma: "Aasdasd",
  tiempo_de_aparicion: "Días",
  otros_sintomas: "asadasds",
  ...
  primer_apellido: "Aasdasds",
  segundo_apellido: "Aasdasdas",
  nombre_del_paciente: "Aasdasdas",
  sexo: "Masculino",
  edad: 0,
  color_de_piel: "Blanca",
  carne_de_identidad: "12312312311",
  ...
  diagnostico_topografico: "asds",
  diagnostico_morfologico: "asdasdas",
  diagnosticado_en: "asdasd",
  ...
  observaciones: "asdasdas",
  nombre_del_medico: "Aasdasdas",
  registro_profesional: "1234",
};
